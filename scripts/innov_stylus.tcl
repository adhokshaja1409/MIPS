set top_design top
set init_lef_file "../../../../libs/SAED32nm/cadence_cap_tech/tech.lef /opt/PDKs/SAED32nm/SAED32_EDK/lib/stdcell_rvt/lef/saed32nm_rvt_1p9m.lef"
...
set link_library_worst "/opt/PDKs/SAED32nm/SAED32_EDK/lib/stdcell_rvt/db_nldm/saed32rvt_ss0p95vn40c.lib /opt/PDKs/SAED32nm/SAED32_EDK/lib/stdcell_rvt/db_nldm/saed32rvt_ss0p75vn40c.lib /opt/PDKs/SAED32nm/SAED32_EDK/lib/stdcell_rvt/db_nldm/saed32rvt_pg_ss0p95vn40c.lib"

set library $link_library_worst

echo create_library_set -name worst_libs -timing \"$link_library_worst\" > mmmc.tcl

echo create_rc_corner -name cmax -T -40 -cap_table ../../../../libs/SAED32nm/cadence_cap_tech/saed32nm_1p9m_Cmax.cap -qrc_tech ../../../../libs/SAED32nm/cadence_cap_tech/tech.lef >> mmmc.tcl
echo create_rc_corner -name cmin -T -40 -cap_table ../../../../libs/SAED32nm/cadence_cap_tech/saed32nm_1p9m_Cmin.cap -qrc_tech ../../../../libs/SAED32nm/cadence_cap_tech/tech.lef >> mmmc.tcl
...
# Change to the latest `read_mmmc` and `read_physical` commands
read_mmmc mmmc.tcl
...
# Add power rings and stripes with updated syntax
add_ring -type core -nets {VDD VSS} -layer {top M7 bottom M7 left M8 right M8} -offset 1 -width 4 -spacing 1.0 -follow core
...
# Add routing commands with updates
route_special -nets {VDD_CPU_OUT VDD VSS} -allow_layer_change 1 -allow_jogging 1 -power_domains PD_CPU -block_pin_target nearest_target

route_special -nets {VDD VSS} -allow_layer_change 1 -allow_jogging 1 -power_domains PD_DMEM
route_special -nets {VDD VSS} -allow_layer_change 1 -allow_jogging 1 -power_domains PD_IMEM
route_special -nets {VDD VSS} -allow_layer_change 1 -allow_jogging 1 -power_domains PD_TOP
...
write_power_intent -1801 ../outputs/top_innov_upf.upf
write_db top_route.innovus

# Save netlist along with power and ground connections for LP verification.
write_netlist ../innovoutputs/top_netlist.vg -phys -include_pg_ports
write_netlist ../innovoutputs/top_netlist_no_pg.vg

write_def ../innovoutputs/top_def.def -floorplan
